...
crop_size_train              = Height            # Crop size during training (Height, Width) or None
crop_size_valid              = Height            # Crop size during validation
crop_size_test               = Height            # Crop size during testing
